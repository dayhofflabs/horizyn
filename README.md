...
Official implementation of the Horizyn SOTA model for contrastive learning between enzymatic reactions and proteins, as described in [our paper](https://www.pnas.org/doi/10.1073/pnas.2520070123). For the very latest version of the model, plus various search and visualization tools, visit the [Horizyn Web App](https://horizyn.dayhofflabs.com/).
